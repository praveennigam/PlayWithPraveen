export const questions = {
  ...
  CLAT: [
    ...
    { "q": "What is the full form of CLAT?", "opts": ["Common Law Admission Test", "Common Law Admission Theory", "Common Law Assessment Test", "Common Law Admission Trial"], "ans": 0 },
    { "q": "Which subject is NOT part of the CLAT syllabus?", "opts": ["English", "Mathematics", "Legal Aptitude", "General Knowledge"], "ans": 1 },
    { "q": "What is the duration of the CLAT exam?", "opts": ["1 hour", "2 hours", "2.5 hours", "3 hours"], "ans": 1 },
    { "q": "Which of the following is a key component of the CLAT exam?", "opts": ["Logical Reasoning", "Physics", "Chemistry", "Biology"], "ans": 0 },
    { "q": "How many questions are there in the CLAT exam?", "opts": ["150", "200", "120", "100"], "ans": 2 },
    { "q": "What is the marking scheme for each correct answer in CLAT?", "opts": ["1 mark", "2 marks", "3 marks", "0.5 marks"], "ans": 0 },
    { "q": "Which section assesses the candidate's understanding of legal principles?", "opts": ["Legal Aptitude", "English", "Current Affairs", "Mathematics"], "ans": 0 },
    { "q": "How many times is the CLAT exam conducted in a year?", "opts": ["Once", "Twice", "Thrice", "Four times"], "ans": 0 },
    { "q": "Which of the following is considered a negative marking?", "opts": ["1 mark deduction for each wrong answer", "No negative marking", "0.25 mark deduction", "2 marks deduction for each wrong answer"], "ans": 0 },
    { "q": "In which year was the first CLAT conducted?", "opts": ["2008", "2010", "2005", "2007"], "ans": 3 },
    { "q": "Which university conducts the CLAT exam?", "opts": ["NLU Delhi", "National Law University, Odisha", "NALSAR", "NLU Jodhpur"], "ans": 0 },
    { "q": "What type of questions are primarily asked in the General Knowledge section?", "opts": ["Current Affairs", "Historical Events", "Legal News", "All of the above"], "ans": 3 },
    { "q": "Which of the following is a recommended book for CLAT preparation?", "opts": ["Legal Aptitude by A.P. Bhardwaj", "NCERT Mathematics", "Chemistry by O.P. Tandon", "English Grammar by Wren & Martin"], "ans": 0 },
    { "q": "Which skill is tested in the Logical Reasoning section?", "opts": ["Analytical skills", "Memory skills", "Mathematical skills", "Scientific skills"], "ans": 0 },
    { "q": "What is the weightage of English Language in CLAT?", "opts": ["20%", "25%", "30%", "15%"], "ans": 1 },
    { "q": "Which section focuses on comprehension passages?", "opts": ["Legal Aptitude", "English", "Logical Reasoning", "General Knowledge"], "ans": 1 },
    { "q": "How many NLUs are part of the CLAT consortium?", "opts": ["22", "18", "20", "15"], "ans": 2 },
    { "q": "Which of the following legal principles is often tested in CLAT?", "opts": ["Contract Law", "Criminal Law", "Constitutional Law", "All of the above"], "ans": 3 },
    { "q": "Which section has the highest number of questions in CLAT?", "opts": ["English", "Current Affairs", "Legal Aptitude", "Logical Reasoning"], "ans": 2 },
    { "q": "What is the time limit for each section in CLAT?", "opts": ["30 minutes", "40 minutes", "50 minutes", "60 minutes"], "ans": 1 },
    { "q": "Which type of reasoning is primarily used in the Logical Reasoning section?", "opts": ["Deductive reasoning", "Inductive reasoning", "Abductive reasoning", "All of the above"], "ans": 3 },
    { "q": "What is the primary aim of the CLAT exam?", "opts": ["To assess legal knowledge", "To select candidates for law schools", "To evaluate reasoning ability", "All of the above"], "ans": 3 },
    { "q": "What is the primary language of the CLAT exam?", "opts": ["Hindi", "English", "Bilingual", "Urdu"], "ans": 1 },
    { "q": "Which topic is included under General Knowledge?", "opts": ["Sports", "Science", "Politics", "All of the above"], "ans": 3 },
    { "q": "What type of law is primarily covered in Legal Aptitude?", "opts": ["Civil Law", "Criminal Law", "Constitutional Law", "All of the above"], "ans": 3 },
    { "q": "Which is NOT a type of question in the CLAT exam?", "opts": ["Multiple Choice Questions", "True/False Questions", "Descriptive Questions", "Assertion and Reasoning Questions"], "ans": 2 },
    { "q": "Which of the following topics is included in the English Language section?", "opts": ["Vocabulary", "Reading Comprehension", "Grammar", "All of the above"], "ans": 3 },
    { "q": "What is the penalty for leaving a question unanswered in CLAT?", "opts": ["No penalty", "1 mark deduction", "0.25 mark deduction", "2 marks deduction"], "ans": 0 },
    { "q": "Which legal term refers to the 'power of the court to hear a case'?", "opts": ["Jurisdiction", "Litigation", "Tort", "Statute"], "ans": 0 },
    { "q": "In legal terms, what does 'plaintiff' mean?", "opts": ["The person being accused", "The person who brings a case", "The judge", "The lawyer"], "ans": 1 },
    { "q": "What is the term for the study of laws and legal systems?", "opts": ["Sociology", "Legal Studies", "Political Science", "Philosophy"], "ans": 1 },
    { "q": "Which of the following is a primary source of law?", "opts": ["Statutes", "Textbooks", "Journals", "None of the above"], "ans": 0 },
    { "q": "What does 'habeas corpus' mean?", "opts": ["You shall have the body", "No one is above the law", "Right to a fair trial", "Freedom of speech"], "ans": 0 },
    { "q": "Which fundamental right guarantees equality before the law?", "opts": ["Right to Equality", "Right to Freedom", "Right to Life", "Right to Constitutional Remedies"], "ans": 0 },
    { "q": "Which document serves as the supreme law of India?", "opts": ["Indian Penal Code", "Constitution of India", "Civil Procedure Code", "Criminal Procedure Code"], "ans": 1 },
    { "q": "What is the purpose of the preamble in the Constitution?", "opts": ["To outline the structure", "To declare the objectives", "To explain the amendments", "None of the above"], "ans": 1 },
    { "q": "Which article of the Indian Constitution deals with the right to freedom of speech?", "opts": ["Article 19", "Article 21", "Article 14", "Article 25"], "ans": 0 },
    { "q": "Which case established the principle of basic structure in the Indian Constitution?", "opts": ["Kesavananda Bharati case", "Maneka Gandhi case", "Minerva Mills case", "Vishaka case"], "ans": 0 },
    { "q": "Who is known as the 'Father of the Constitution' in India?", "opts": ["B.R. Ambedkar", "Jawaharlal Nehru", "Sardar Patel", "Gandhi"], "ans": 0 },
    { "q": "Which of the following is NOT a type of writ?", "opts": ["Habeas Corpus", "Mandamus", "Prohibition", "Exclusion"], "ans": 3 },
    { "q": "What does the term 'jurisprudence' refer to?", "opts": ["The philosophy of law", "Legal principles", "Court procedures", "Statutory interpretation"], "ans": 0 },
    { "q": "Which of the following is a legal right?", "opts": ["Right to education", "Right to health", "Right to privacy", "All of the above"], "ans": 3 },
    { "q": "What does 'pro bono' mean?", "opts": ["For the public good", "For profit", "For a fee", "For a client"], "ans": 0 },
    { "q": "Which principle states that no one is above the law?", "opts": ["Rule of Law", "Separation of Powers", "Judicial Review", "Checks and Balances"], "ans": 0 },
    { "q": "What is the primary function of the judiciary?", "opts": ["To make laws", "To interpret laws", "To enforce laws", "To amend laws"], "ans": 1 },
    { "q": "Which of the following is an example of a legal profession?", "opts": ["Doctor", "Engineer", "Lawyer", "Teacher"], "ans": 2 },
    { "q": "What does 'mens rea' refer to in criminal law?", "opts": ["Intent to commit a crime", "The act of committing a crime", "Knowledge of wrongdoing", "All of the above"], "ans": 3 },
    { "q": "Which of the following is a function of the Parliament?", "opts": ["Making laws", "Amending the Constitution", "Budget approval", "All of the above"], "ans": 3 },
    { "q": "What is the term for a written law passed by a legislative body?", "opts": ["Statute", "Ordinance", "Bill", "Regulation"], "ans": 0 },
    { "q": "Which Article of the Constitution deals with the Right to Equality?", "opts": ["Article 14", "Article 19", "Article 21", "Article 22"], "ans": 0 },
    { "q": "Which of the following is NOT a fundamental right?", "opts": ["Right to Education", "Right to Property", "Right to Equality", "Right to Freedom of Speech"], "ans": 1 },
    { "q": "What does 'stare decisis' mean?", "opts": ["To stand by things decided", "To make new laws", "To interpret laws", "To repeal old laws"], "ans": 0 },
