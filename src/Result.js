...
const Result = ({ correct, wrong, totalQuestions, solvedQuestions }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen/2  bg-gradient-to-br from-purple-800 to-blue-600 p-6 relative overflow-hidden shadow-2xl rounded-lg">
