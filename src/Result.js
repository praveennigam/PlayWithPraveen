  ...
  return (
    <div className="flex items-center justify-center bg-gradient-to-br from-purple-800 to-blue-600 p-6 relative overflow-hidden shadow-2xl rounded-lg">
      ...
      <div className="max-w-lg w-full bg-white bg-opacity-10 backdrop-blur-lg p-8 rounded-lg shadow-2xl transition-transform transform mt-4 relative z-10">
        ...
        <p className="text-lg text-white mb-2">Correct Answers:
          <span className="font-bold text-green-400">{correct}</span>
        </p>

        <p className="text-lg text-white mb-2">Wrong Answers:
          <span className="font-bold text-red-400">{wrong}</span>
        </p>

        <p className="text-lg text-white mb-2">Total Questions:
          <span className="font-bold text-blue-400">{totalQuestions}</span>
        </p>

        <p className="text-lg text-white mb-2">Solved Questions:
          <span className="font-bold text-yellow-400">{solvedQuestions}</span>
        </p>

        <p className="text-lg text-white mb-6">Your Score:
          <span className="font-bold text-yellow-400">{percentage}%</span>
        </p>
